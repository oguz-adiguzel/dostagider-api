...
const options = {
  definition: {
    ...
    components: {
      ...
      schemas: {
        // ... (Paylaştığın tüm o şemalar burada kalacak)
      }
    }
  },
  // Hangi dosyalardan swagger yorumlarını okuyacağını buraya yazıyoruz:
  apis: ["./routes/*.js", "./controllers/*.js"] // Dosya yapına göre burayı güncelle kral!
};
